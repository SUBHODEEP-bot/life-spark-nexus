...
import { ActivitySquare, BarChart3, Bell, Calendar, CheckSquare, Heart, HelpCircle, Home, MessageCircle, Newspaper, Shield, Star, User, UserCog, Mic, AlertTriangle, LucideIcon, Award, Wallet, Languages, Mail, Clock } from "lucide-react";
...
const Dashboard = () => {
  ...
  return <div className="container max-w-6xl mx-auto space-y-8">
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-6 text-gray-50">All Modules</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {modulesList.map(module => <Card key={module.id} className="module-card group" onClick={() => navigate(module.path)}>
